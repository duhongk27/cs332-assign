...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    val timeOut: Future[String] = Future {blocking(Thread.sleep(20000))}
      .continue {
      _ => "Server timeout!"
    }
    ...
    val terminationRequested: Future[String] = Future.firstCompletedOf(Seq(userInterrupted, timeOut))
